import Reactfunc  from "react";

const Content = () => {
    return (
        <nav className="container">
            <div>
                <h1>gsoulis (re)build</h1>
                <p>
                ...
                <p>
                    ...
                    My current projects include preparing for the CompTIA Security+ and Certified Red Team Operator exams, exploring DLL Injection, and studying malware analysis.
                    As I navigate my final year at university, I'm keen on engaging in extracurricular activities.
                </p>
                <p>
                    I'm actively involved in a cybersecurity club called SWIFT and serve as a team captain in cyber competitions such as NCAE and Cyberforce, where we recently achieved first place in the blue-teamers category.
                </p>
                <p>
                    Additionally, I contribute as a developer for the Bronco-Hacks club, focusing on the static aspects of the website. I intend to keep this blog updated with my latest projects and achievements and challenges.
                </p>
                <footer>
                    <p>
